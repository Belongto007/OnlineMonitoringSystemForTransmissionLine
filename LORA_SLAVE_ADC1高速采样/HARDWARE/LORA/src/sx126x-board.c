...
{
  while(HAL_GPIO_ReadPin(RADIO_BUSY_PORT,RADIO_BUSY_PIN)== GPIO_PIN_SET);  //while(GPIO_ReadInputDataBit(RADIO_BUSY_PORT,RADIO_BUSY_PIN)==Bit_SET);
...
{
   HAL_GPIO_WritePin(RADIO_NSS_PORT,RADIO_NSS_PIN,GPIO_PIN_RESET);// GPIO_WriteBit( RADIO_NSS_PORT, RADIO_NSS_PIN,Bit_RESET);
   
    SpiInOut(RADIO_GET_STATUS);
    SpiInOut(0);
    
    HAL_GPIO_WritePin(RADIO_NSS_PORT,RADIO_NSS_PIN,GPIO_PIN_SET);//GPIO_WriteBit( RADIO_NSS_PORT, RADIO_NSS_PIN,Bit_SET);
