...
extern int tp_buffer0[buffersize];
extern int tp_buffer1[buffersize];
extern float vl_buffer0[buffersize];
extern float vl_buffer1[buffersize];
extern float vl_buffer2[buffersize];
extern uint8_t tjcstate;
